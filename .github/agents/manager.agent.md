...
tools:
  [
    ...
    web/fetch,
    web/githubRepo,
    primeng/compare_components,
    primeng/export_component_docs,
    primeng/find_by_event,
    primeng/find_by_prop,
    primeng/find_components_with_feature,
    primeng/generate_component_template,
    primeng/get_accessibility_guide,
    primeng/get_accessibility_info,
    primeng/get_categories,
    primeng/get_component,
    primeng/get_component_events,
    primeng/get_component_import,
    primeng/get_component_methods,
    primeng/get_component_props,
    primeng/get_component_pt,
    primeng/get_component_sections,
    primeng/get_component_slots,
    primeng/get_component_styles,
    primeng/get_component_tokens,
    primeng/get_component_url,
    primeng/get_configuration,
    primeng/get_data_components,
    primeng/get_example,
    primeng/get_form_components,
    primeng/get_guide,
    primeng/get_icons_guide,
    primeng/get_installation,
    primeng/get_migration_guide,
    primeng/get_overlay_components,
    primeng/get_passthrough_guide,
    primeng/get_performance_tips,
    primeng/get_related_components,
    primeng/get_tailwind_guide,
    primeng/get_theming_guide,
    primeng/get_theming_info,
    primeng/get_usage_example,
    primeng/get_version_info,
    primeng/list_components,
    primeng/list_examples,
    primeng/list_guides,
    primeng/migrate_v18_to_v19,
    primeng/migrate_v19_to_v20,
    primeng/migrate_v20_to_v21,
    primeng/search_all,
    primeng/search_components,
    primeng/suggest_component,
    primeng/validate_props,
